...
.method public static final asStream(Lkotlin/sequences/Sequence;)Ljava/util/stream/Stream;
    ...
    .line 64
    new-instance v0, Lkotlin/streams/jdk8/StreamsKt$$ExternalSyntheticLambda5;

    invoke-direct {v0, p0}, Lkotlin/streams/jdk8/StreamsKt$$ExternalSyntheticLambda5;-><init>(Lkotlin/sequences/Sequence;)V

    const/16 p0, 0x10

    const/4 v1, 0x0

    invoke-static {v0, p0, v1}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/function/Supplier;IZ)Ljava/util/stream/Stream;
...
.method private static final asStream$lambda$4(Lkotlin/sequences/Sequence;)Ljava/util/Spliterator;
    ...
    invoke-static {p0, v0}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/Iterator;I)Ljava/util/Spliterator;
...
.method public static final toList(Ljava/util/stream/DoubleStream;)Ljava/util/List;
    ...
    .line 96
    invoke-static {p0}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/stream/DoubleStream;)[D
...
.method public static final toList(Ljava/util/stream/IntStream;)Ljava/util/List;
    ...
    .line 80
    invoke-static {p0}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/stream/IntStream;)[I
...
.method public static final toList(Ljava/util/stream/LongStream;)Ljava/util/List;
    ...
    .line 88
    invoke-static {p0}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Ljava/util/stream/LongStream;)[J
...
.method public static final toList(Ljava/util/stream/Stream;)Ljava/util/List;
    ...
    invoke-static {p0, v0}, Landroidx/credentials/provider/Action$Companion$$ExternalSyntheticApiModelOutline1;->m(Ljava/util/stream/Stream;Ljava/util/stream/Collector;)Ljava/lang/Object;
