...
.method private static final coerceToMillis(Ljava/time/Duration;)J
    ...
    .line 65
    invoke-static {}, Lokio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline0;->m()Ljava/time/Duration;

    move-result-object v0

    invoke-static {p0, v0}, Lokio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline0;->m(Ljava/time/Duration;Ljava/time/Duration;)I
    ...
    .line 66
    :cond_0
    invoke-static {}, Lokio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline0;->m()Ljava/time/temporal/ChronoUnit;

    move-result-object v0

    invoke-static {v0}, Lokio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline0;->m(Ljava/time/temporal/ChronoUnit;)Ljava/time/Duration;
    ...
    .line 71
    :cond_1
    invoke-static {p0}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Ljava/time/Duration;)J
    ...
    invoke-static {p0}, Lkotlin/io/path/PathTreeWalk$$ExternalSyntheticApiModelOutline0;->m(Ljava/time/Duration;)I
    ...
    :cond_3
    :goto_0
    invoke-static {p0}, Lokio/NioSystemFileSystem$$ExternalSyntheticApiModelOutline0;->m(Ljava/time/Duration;)J
