...
.method public final fromSlice(Landroid/app/slice/Slice;)Landroidx/credentials/provider/AuthenticationAction;
    ...
    invoke-static {v3}, Landroidx/credentials/provider/Action$Companion$$ExternalSyntheticApiModelOutline1;->m(Ljava/lang/Object;)Landroid/app/slice/SliceItem;
    ...
    invoke-static {v3, v4}, Landroidx/credentials/provider/Action$Companion$$ExternalSyntheticApiModelOutline1;->m(Landroid/app/slice/SliceItem;Ljava/lang/String;)Z
    ...
    .line 147
    invoke-static {v3}, Landroidx/credentials/provider/Action$Companion$$ExternalSyntheticApiModelOutline1;->m(Landroid/app/slice/SliceItem;)Landroid/app/PendingIntent;
    ...
    .line 149
    invoke-static {v3}, Landroidx/credentials/provider/Action$Companion$$ExternalSyntheticApiModelOutline1;->m(Landroid/app/slice/SliceItem;)Ljava/lang/CharSequence;
...
.method public final toSlice(Landroidx/credentials/provider/AuthenticationAction;)Landroid/app/slice/Slice;
    ...
    invoke-static {}, Landroidx/credentials/provider/Action$Companion$$ExternalSyntheticApiModelOutline0;->m$4()V
    ...
    .line 113
    invoke-static {v2, v3}, Landroidx/credentials/provider/Action$Companion$$ExternalSyntheticApiModelOutline1;->m(Ljava/lang/String;I)Landroid/app/slice/SliceSpec;

    move-result-object v2

    .line 112
    invoke-static {v1, v2}, Landroidx/credentials/provider/Action$Companion$$ExternalSyntheticApiModelOutline1;->m(Landroid/net/Uri;Landroid/app/slice/SliceSpec;)Landroid/app/slice/Slice$Builder;

    move-result-object v1

    .line 121
    invoke-static {v1}, Landroidx/credentials/provider/Action$Companion$$ExternalSyntheticApiModelOutline1;->m(Landroid/app/slice/Slice$Builder;)Landroid/app/slice/Slice$Builder;
    ...
    invoke-static {v2, v3}, Landroidx/credentials/provider/Action$Companion$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/slice/Slice$Builder;Ljava/util/List;)Landroid/app/slice/Slice$Builder;

    move-result-object v2

    .line 123
    invoke-static {v2}, Landroidx/credentials/provider/Action$Companion$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/slice/Slice$Builder;)Landroid/app/slice/Slice;
    ...
    .line 119
    invoke-static {v1, p1, v2, v3}, Landroidx/credentials/provider/Action$Companion$$ExternalSyntheticApiModelOutline0;->m(Landroid/app/slice/Slice$Builder;Landroid/app/PendingIntent;Landroid/app/slice/Slice;Ljava/lang/String;)Landroid/app/slice/Slice$Builder;
    ...
    invoke-static {p1, v0, v3, v2}, Landroidx/credentials/provider/Action$Companion$$ExternalSyntheticApiModelOutline1;->m(Landroid/app/slice/Slice$Builder;Ljava/lang/CharSequence;Ljava/lang/String;Ljava/util/List;)Landroid/app/slice/Slice$Builder;
